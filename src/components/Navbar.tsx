        ...
        <nav className="fixed top-0 left-0 right-0 z-[100] bg-white/80 backdrop-blur-md border-b border-slate-200 h-20 shadow-sm">
            <div className="max-w-7xl mx-auto px-4 md:px-8 h-full flex items-center justify-between">
                <Link href="/" className="flex items-center gap-4 group transition-all duration-300 active:scale-95">
                    ...
                    <div>
                        <h1 className="text-lg font-black text-slate-900 uppercase tracking-tighter leading-none">VYN.md</h1>
                        <p className="text-[10px] text-slate-400 font-black tracking-widest uppercase leading-none mt-1">Registry Platform</p>
                    </div>
                </Link>
                ...
                <div className="flex items-center gap-2 md:gap-4">
                    <Button
                        ...
                        className="flex items-center gap-2 rounded-xl font-black text-slate-600 hover:bg-slate-100 px-4 transition-all"
                    >
